CLASS /dmo/cl_rap_xco_json_visitor DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING io_root_node TYPE REF TO /dmo/cl_rap_node
  ...
  PRIVATE SECTION.
    ...
    TYPES: BEGIN OF t_valuehelp,
             ...
             additional_binding TYPE /dmo/cl_rap_node=>tt_addtionalbinding,
           END OF t_valuehelp.
    ...
    TYPES: BEGIN OF t_association,
             ...
             condition_fields TYPE /dmo/cl_rap_node=>tt_condition_fields,
           END OF t_association.

    TYPES : BEGIN OF t_objects_with_add_fields,
              object            TYPE string,
              additional_fields TYPE /dmo/cl_rap_node=>tt_additional_fields,
...
*        array_level_obj_with_add_f = array_level.
      ...
      WHEN OTHERS.
        RAISE EXCEPTION TYPE /dmo/cx_rap_generator
          EXPORTING
            textid   = /dmo/cx_rap_generator=>invalid_json_array_name
